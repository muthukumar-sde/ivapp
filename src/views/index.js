...
import LinkExpired from './link_expired';
import VerificationSuccess  from './verification_success';
		...
		return (
			<Fragment>
				...
				<Switch>
					...
					<Route path={`${match.url}link_expired`} component={LinkExpired} />
					<Route path={`${match.url}verification_success`} component={VerificationSuccess} />
					<Route path={`${match.url}session_expired`} component={SessionExpired} />
